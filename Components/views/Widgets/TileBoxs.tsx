                            ...
                            <div className="d-flex justify-content-between">
                                <div className="flex-grow-1">
                                    ...
                                    <h4 className="fs-22 fw-semibold mb-3">
                                        <span className="counter-value" data-target="745.35">
                                            $745.35
                                        </span>
                                    </h4>
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="text-end flex-grow-1">
                                    ...
                                    <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="698.36">
                                        698.36k
                                    </span></h4>
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                <div className="flex-grow-1">
                                    ...
                                    <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="195.38">
                                        195.38M
                                    </span></h4>
                                    <div className="d-flex align-items-center gap-2">
                                        <h5 className="text-success fs-12 mb-0">
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="text-end flex-grow-1">
                                    ...
                                    <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="190.73">
                                        190.73k
                                    </span></h4>
                                    <div className="d-flex align-items-center justify-content-end gap-2">
                                        <h5 className="text-danger fs-12 mb-0">
                    ...
                    <Card className="card-animate">
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 className="fs-22 fw-semibold mb-4"><span className="counter-value" data-target="559.25">
                                        $559.25k
                                    </span></h4>
                ...
                <Col xl={3} md={6}>
                    ...
                    <Card className="card-animate bg-info">
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 className="fs-22 fw-semibold mb-4 text-white"><span className="counter-value" data-target="36894">
                                        36,894
                                    </span></h4>
                                    <Link href="#" scroll={false} className="text-decoration-underline text-white-50">View all orders</Link>
                                </div>
                                <div className="avatar-sm flex-shrink-0">
                                    <span className="avatar-title bg-light-subtle rounded fs-3">
                ...
                <Col xl={3} md={6}>
                    ...
                    <Card className="card-animate">
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 className="fs-22 fw-semibold mb-4"><span className="counter-value" data-target="183.35">
                                        183.35M
                                    </span></h4>
                ...
                <Col xl={3} md={6}>
                    ...
                    <Card className="card-animate">
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 className="fs-22 fw-semibold mb-4"><span className="counter-value" data-target="190.73">
                                        $190.73k
                                    </span></h4>
                ...
                <Col xl={3} md={6}>
                    <Card className="bg-success card-height-100">
                        <Card.Body>
                            <div className="d-flex align-items-center">
                                <div className="avatar-sm flex-shrink-0">
                                    <span className="avatar-title bg-light-subtle text-white rounded-2 fs-2">
                                        <i className="bx bx-shopping-bag"></i>
                                    </span>
                                </div>
                                <div className="flex-grow-1 ms-3">
                                    <p className="text-uppercase fw-medium text-white-75 mb-3 fs-13">Total Sales</p>
                                    <h4 className="fs-4 mb-3 text-white"><span className="counter-value" data-target="2045">
                                        2,045
                                    </span></h4>
                                    <p className="text-white-75 mb-0">From 1930 last year</p>
                                </div>
                                <div className="flex-shrink-0 align-self-center">
                                    <span className="badge bg-light-subtle text-success fs-12"><i className="ri-arrow-up-s-line fs-13 align-middle me-1"></i>6.11 %<span></span></span>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <h4 className="fs-4 mb-3"><span className="counter-value" data-target="7522">
                                        7,522
                                    </span></h4>
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <h4 className="fs-4 mb-3">$<span className="counter-value" data-target="2845.05">
                                        2,845.05
                                    </span></h4>
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <h4 className="fs-4 mb-3"><span className="counter-value" data-target="405">
                                        405k
                                    </span></h4>
