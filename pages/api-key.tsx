                            ...
                            <Card className="card-animate card-height-100">
                                <Card.Body>
                                    <div className="d-flex justify-content-between">
                                        <div>
                                            <p className="fw-medium text-muted mb-0">Successful conversions</p>
                                            <h2 className="mt-4 fw-semibold"><span className="counter-value" data-target="50">
                                                50
                                            </span></h2>
                                ...
                                <Card.Body>
                                    <div className="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h2 className="mt-4 fw-semibold"><span className="counter-value" data-target="8">
                                                8
                                            </span></h2>
