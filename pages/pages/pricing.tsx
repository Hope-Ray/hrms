                                            ...
                                            <div className="form-check card-radio" key={key} onClick={() => setPlan(item)}>
                                                ...
                                                <label className="form-check-label" htmlFor={"plans" + item.id}>
                                                    <span className="d-flex align-items-center">
                                                        <span className="fw-semibold d-block flex-grow-1 fs-15 text-uppercase">{item.plan}</span>
                                    ...
                                    <Row className="mb-3">
                                        ...
                                        <Col lg={6}>
                                            <ul className="list-unstyled vstack gap-3 mb-0">
                                                <li>Users: <span className="text-primary fw-semibold">{item.users}</span></li>
                                                <li>Storage: <span className="text-primary fw-semibold">{item.storage}</span></li>
                                                <li>Domain: <span className="text-primary fw-semibold">{item.domain}</span></li>
                                                <li>Support: <span className="text-primary fw-semibold">{item.support}</span></li>
                                            </ul>
                                        </Col>
                                    </Row>
                                    <div>
