                                                            ...
                                                            <Card.Header className="p-4">
                                                                ...
                                                                <ul className="list-inline mb-2">
                                                                    <li className="list-inline-item">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-soft-dark"><i className="ph-globe-simple align-middle"></i> Website</Link>
                                                                    </li>
                                                                    <li className="list-inline-item">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-soft-dark"><i className="ph-map-pin align-middle"></i> Locations</Link>
                                                                    </li>
                                                                    <li className="list-inline-item">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-soft-dark"><i className="ph-phone align-middle"></i> Contact Us</Link>
                                                                    </li>
                                                                </ul>
