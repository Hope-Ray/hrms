                                    ...
                                    <Card.Body className="p-4 m-2">
                                        <Row className="mb-4 pb-2">
                                            ...
                                            <Dropdown className="col text-end" drop="start">
                                                ...
                                                <Dropdown.Menu as="ul" className="dropdown-menu-end">
                                                    <li><Dropdown.Item className="dropdown-item edit-list" href="#addmemberModal" data-bs-toggle="modal" data-edit-id="12"><i className="ri-pencil-line me-2 align-bottom text-muted"></i>Edit</Dropdown.Item ></li>
                                                    <li><Dropdown.Item className="dropdown-item remove-list" href="#removeMemberModal" data-bs-toggle="modal" data-remove-id="12"><i className="ri-delete-bin-5-line me-2 align-bottom text-muted"></i>Remove</Dropdown.Item ></li>
                                                </Dropdown.Menu>
                                            </Dropdown>
                        ...
                        <Row>
                            <Col lg={12}>
                                ...
                                <div className="hstack gap-2 justify-content-end">
                                    ...
                                    <Button variant='success' type="submit" id="addNewMember">{!!isEdit ? "Edit Member" : "Add Member"}</Button>
                                </div>
                            </Col>
                        </Row>
                    </Form>
